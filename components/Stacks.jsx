                ...
                <div className="space-y-8 p-4">
                    ...
                    <div className="flex flex-col md:flex-row items-start md:items-start gap-6">
                        ...
                        <div className="flex gap-6">
                            <div className="group flex flex-col items-center gap-2 p-4 bg-white/5 rounded-xl border border-white/10 hover:bg-white/10 hover:border-green-500/50 transition-all duration-300 hover:scale-105">
